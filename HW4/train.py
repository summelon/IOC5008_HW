...
def build_coco_results(dataset, image_ids, rois, class_ids, scores, masks):
    ...
    for image_id in image_ids:
        ...
        for i in range(rois.shape[0]):
            ...
            pred['category_id'] = int(dataset.get_source_class_id(class_id, "coco"))
...
def evaluate_coco(model, dataset, coco, eval_type="bbox", limit=0, image_ids=None):
    ...
    with open('./submission/submission.json', 'w') as file:
...
if __name__ == '__main__':
    ...
    if args.command == "train":
        ...
        dataset_val = CocoDataset()
        #val_type = "val" if args.year in '2017' else "minival"
        coco = dataset_val.load_coco(args.dataset, "eval", year=args.year, return_coco=True, auto_download=args.download)
        dataset_val.prepare()

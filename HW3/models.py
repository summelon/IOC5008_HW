...
def attempt_download(weights):
    ...
    if weights and not os.path.isfile(weights):
        ...
        if file == 'yolov3-spp.weights':
            gdrive_download(
                id='16lYS4bcIdM2HdmyJBVDOvt3Trx6N3W2R', name=weights)
        elif file == 'yolov3.weights':
            gdrive_download(
                id='1uTlyDWlnaqXcsKOktP5aH_zRDbfcDp-y', name=weights)
        elif file == 'yolov3-spp.pt':
            gdrive_download(
                id='1f6Ovy3BSq2wYq4UfvFUpxJFNDFfrIDcR', name=weights)
        elif file == 'yolov3.pt':
            gdrive_download(
                id='1SHNFyoe5Ni8DajDNEqgB2oVKBb_NoEad', name=weights)
        elif file == 'yolov3-tiny.pt':
            gdrive_download(
                id='10m_3MlpQwRtZetQxtksm9jqHrPTHZ6vo', name=weights)
        elif file == 'darknet53.conv.74':
            gdrive_download(
                id='1WUVBid-XuoUBmvzBVUCBl_ELrzqwA8dJ', name=weights)
        elif file == 'yolov3-tiny.conv.15':
            gdrive_download(
                id='1Bw0kCpplxUqyRYAJr9RY9SGnOJbo9nEj', name=weights)
        elif file == 'ultralytics49.pt':
            gdrive_download(
                id='158g62Vs14E3aj7oPVPuEnNZMKFNgGyNq', name=weights)
        else:
        ...
        # weights < 5MB (too small), download failed
        if os.path.getsize(weights) < 5E6:
